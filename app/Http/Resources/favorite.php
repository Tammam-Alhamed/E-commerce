...
use App\Http\Resources\sizesItems;
use App\Http\Resources\colorsItems;
use App\Http\Resources\imagesItems;
...
class favorite extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            'favorite_usersid' => "$this->favorite_usersid",
            'favorite_itemsid' => "$this->favorite_itemsid",
            'id' => "$this->id",
